...
public class LoginPageQuestions {
    ...
    public static Question<Boolean> isUsernameFieldVisible() {
        return actor -> Visibility.of(LoginPage.USERNAME_FIELD )
                .answeredBy(actor);
    }
    ...
    public static Question<Boolean> isRememberMeCheckboxVisible() {
        return actor -> Visibility.of(LoginPage.REMEMBER_ME_CHECKBOX )
                .answeredBy(actor);
    }
    ...
    public static Question<Boolean> isSignUpButtonVisible() {
        return actor -> Visibility.of(LoginPage.SIGNUP_BUTTON )
                .answeredBy(actor);
    }
}
